...
@WebServlet(name = "SearchStudentDetails", urlPatterns = {"/SearchStudentDetails"})
	...
	public void doPost(HttpServletRequest req, HttpServletResponse res){
		...
		try{
			...
			out.println("<!DOCTYPE html>"+
						...
						"    <style>"+
						"        @import url(\"./css/search_response.css\")"+
						"    </style>"+
						"</head>"+
						"<body>"+
						"    <div class=\"main\">"+
			...
			if(rs.next()){
				...
				for(int i=1;i<=column;i++){
					...
					out.println("<tr>"+
								"	<td>"+rsmd.getColumnName(i)+"</td><td><input type=\"text\" value=\""+rs.getString(i)+"\" disabled></td>"+
								"</tr"
							);
				}
			}
